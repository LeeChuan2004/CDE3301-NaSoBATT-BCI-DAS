...
// Waveshare TESP32-S3-Touch-LCD-3.5, 320 × 480, Controller: ST7796
// https://www.waveshare.com/esp32-s3-touch-lcd-3.5.htm?sku=30934
...
void setup()
{
    ...
    // Try both HIGH and LOW for 1s each to find the active level:
    digitalWrite(TFT_BL, HIGH);
    delay(1000);
    digitalWrite(TFT_BL, LOW);
    delay(1000);
    digitalWrite(TFT_BL, HIGH); // leave on if HIGH is correct
#endif
