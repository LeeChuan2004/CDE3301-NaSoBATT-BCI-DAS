...
// Note - #include <User_Setups/2_Waveshare_ST7796.h> // Setup file for Waveshare ST7796 display bought from Waveshare
#include <User_Setups/1_Waveshare_ILI9486_Kuriosity.h> // Setup file for Waveshare ILI9486 display bought from Kuriosity
